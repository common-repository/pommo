...
<div id="menu">
	{$config.app.weblink}
	<a href="{$url.base}admin/admin.php{"?"|bmAppendPoMMoInstance}">{t}Admin Page{/t}</a>
</div>
...
<input type="hidden" name="pk" value="{$smarty.const.poMMo_instance}">
 ...
 {/if}
	...
	<fieldset>
		...
		<input type="hidden" name="admin_password" value="(Not Used)" id="admin_password" />
		<input type="hidden" name="admin_password2" value="(Not Used)" id="admin_password2" />
{*	
		<div class="field">
...
<br><br>
<a href="{$url.base}admin/setup/admin_setup.php{"?"|bmAppendPoMMoInstance}">
		<img src="{$url.theme.shared}images/icons/back.png" align="middle" class="navimage" border='0'>
		{t}Continue to Admin page{/t}</a>
<br>
