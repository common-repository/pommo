...
<div id="mainbar">
	...
	<p>
		<a href="{$url.base}user/subscribe.php{"?"|bmAppendPoMMoInstance}">
	...
	<p>
		<a href="{$url.base}admin/setup/form_embed.php{"?"|bmAppendPoMMoInstance}">
	...
	<p>
		<a href="{$url.base}admin/setup/form_generate.php{"?"|bmAppendPoMMoInstance}">
	...
	<ul>
		<li>{t}Default Form{/t} -> {$url.base}user/subscribe.php{"?"|bmAppendPoMMoInstance}
		<li>{t}Embedded Form{/t} -> {$url.base}embed.form.php{"?"|bmAppendPoMMoInstance}
		<li>{t}Embedded Mini Form{/t} -> {$url.base}embed.miniform.php{"?"|bmAppendPoMMoInstance}
	</ul>
