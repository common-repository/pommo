  ...
  <fieldset>
    ...
    <legend>{t}Advanced{/t}</legend>
		...
		{if $list_exchanger == 'smtp'}
			<div class="field">
				<a href="setup_smtp.php{"?"|bmAppendPoMMoInstance}">
					<img src="{$url.theme.shared}images/icons/right.png" align="center" border="0">
				</a>
				  &nbsp; {t escape=no 1='<a href="setup_smtp.php?pk='|cat:$smarty.const.poMMo_instance|cat:'">' 2='</a>}SMTP Servers: %1 Click Here %2 to setup your relays.{/t}
				<div class="notes">{t}(configure SMTP relays){/t}</div>
			</div>
		{/if}
		
		<div class="field">
			<a href="setup_messages.php{"?"|bmAppendPoMMoInstance}">
				<img src="{$url.theme.shared}images/icons/right.png" align="center" border="0">
			</a>
			  &nbsp; {t escape=no 1='<a href="setup_messages.php?pk='|cat:$smarty.const.poMMo_instance|cat:'">' 2='</a>}Messages: %1 Click Here %2 to customize mailed messages.{/t}
		...
		<div class="field">
			<a href="setup_throttle.php{"?"|bmAppendPoMMoInstance}">
				<img src="{$url.theme.shared}images/icons/right.png" align="center" border="0">
			</a>
			  &nbsp; {t escape=no 1='<a href="setup_throttle.php?pk='|cat:$smarty.const.poMMo_instance|cat:'">' 2='</a>}Throttling: %1 Click Here %2 to set mail throttle values.{/t}
