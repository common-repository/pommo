...
<div id="mainbar">
	...
	<p>
		...
		<a href="{$url.base}user/subscribe.php{"?"|bmAppendPoMMoInstance}">{t}Default Subscribe Form{/t}</a>.
	</p>
	

<a href="setup_form.php{"?"|bmAppendPoMMoInstance}">
...
<tr class="bgOdd">
	<td style="text-align: right;">
		<strong>
			...
			<span style="margin-right: 20px;">
				<a href="{$url.base}embed.miniform.php{"?"|bmAppendPoMMoInstance}">{t}URL{/t}</a>
			</span> 
		</strong>
	</td>
</tr>
...
<tr class="bgOdd">
	<td><strong>PHP</strong> -> include('{$url.base}embed.miniform.php{"?"|bmAppendPoMMoInstance}');</td>
</tr>
<tr>
...
<tr class="bgOdd">
	<td style="text-align: right;">
		<strong>
			...
			<span style="margin-right: 20px;">
				<a href="{$url.base}embed.form.php{"?"|bmAppendPoMMoInstance}">{t}URL{/t}</a>
			</span> 
		</strong>
	</td>
</tr>
...
<tr class="bgOdd">
	<td><strong>PHP</strong> -> include('{$url.base}embed.form.php{"?"|bmAppendPoMMoInstance}');</td>
</tr>
</table>
...
<div id="miniPreview" class="lightbox">
	...
	<br>
	"include('{$url.base}embed.mini.php{"?"|bmAppendPoMMoInstance}');"
...
<div id="fullPreview" class="lightbox">
	...
	<strong>PHP Include</strong>
	<br>
	"include('{$url.base}embed.form.php{"?"|bmAppendPoMMoInstance}');"
