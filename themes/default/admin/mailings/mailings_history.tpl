			...
			<table cellspacing="0" cellpadding="5" border="0" style="text-align: left; margin: 10px; margin-left:auto; margin-right:auto; ">
				...
				{foreach name=mailloop from=$mailings key=key item=mailitem}
					<tr bgcolor="{cycle values="#EFEFEF,#FFFFFF"}">
							...
							<td style="text-align:center;" nowrap>
									<a href="mailings_mod.php?mailid={$mailitem.mailid}&action=delete{"&"|bmAppendPoMMoInstance}">{t}delete{/t}</a>
							</td>

							<td style="text-align:center;" nowrap>
									<a href="mailings_mod.php?mailid={$mailitem.mailid}&action=view{"&"|bmAppendPoMMoInstance}">{t}view{/t}</a>
							</td>

							<td style="text-align:center;" nowrap>
									<a href="mailings_mod.php?mailid={$mailitem.mailid}&action=reload{"&"|bmAppendPoMMoInstance}">
							...
							{if $mailitem.ishtml == 'on'}
								<a href="{"mailing_preview.php?action=viewhtml"|bmAppendPoMMoInstance}&viewid={$mailitem.mailid}" target="_blank">
