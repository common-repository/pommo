...
<div style="background-color: #E6ECDA;">
	...
	<tr>
	<td valign="middle">
		<a href="mailings_send.php{"?"|bmAppendPoMMoInstance}">
...
<div style="background-color: #F6F8F1;">
	...
	<td valign="top">
	<br>
	<a href="mailings_send2.php{"?"|bmAppendPoMMoInstance}">
		<img src="{$url.theme.shared}images/icons/left.png" border="0">&nbsp;<br>{t}edit{/t}
	</a>
	<td>
	...
	{if $ishtml == 'html'}
		<p>
			<b>{t}HTML Body:{/t} </b>
			 <a href="mailing_preview.php{"?"|bmAppendPoMMoInstance}" target="_blank">{t escape=no 1='</a>'}Click here %1 to view in a new browser window.{/t}
		</p>
		{if $altbody}
		<p>
			<b>{t}Alt Body:{/t} </b>
	...
	<div align="center">
	<br><br>
		<a href="mailings_send3.php?sendaway=TRUE{"&"|bmAppendPoMMoInstance}">
			<img src="{$url.theme.shared}images/icons/send.png" class="navimage" border="0">
			<br>{t}Send Mailing{/t}
		</a>
		<br />
		<br/>
		<a href="mailings_send3.php?cancel=TRUE{"&"|bmAppendPoMMoInstance}">{t}Cancel{/t}</a>
	</div>
