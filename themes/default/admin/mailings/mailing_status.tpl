	...
	<div style="position: relative;">
		...
		<div class="stacked" id="startedCmd" style="z-index: 1; visibility: hidden;">
			<span style="position: absolute; left: 0;">
				<a href="mailing_status2.php?command=pause{"&"|bmAppendPoMMoInstance}">
					<img src="{$url.theme.shared}images/icons/pause-small.png" border="0" align="absmiddle">
					{t}Pause Mailing{/t}
				</a> 
			</span>
			<span style="position: absolute; right: 0;">
				<a href="mailing_status2.php?command=kill{"&"|bmAppendPoMMoInstance}">
					{t}Cancel Mailing{/t}
		...
		<div class="stacked" id="stoppedCmd" style="z-index: 2; visibility: hidden;">
			<span style="position: absolute; left: 0;">
				<a href="mailing_status2.php?command=restart{"&"|bmAppendPoMMoInstance}">
		...
		<div class="stacked" id="finishedCmd" style="z-index: 3; visibility: hidden;">
			{t}Mailing Finished{/t} -- <a href="admin_mailings.php{"?"|bmAppendPoMMoInstance}">{t}Return to{/t} {t}Mailings Page{/t}</a>
		</div>
...
<div id = "notices" style="position: relative; visibility: hidden;">
	...
	<a href="mailing_status2.php?command=clear{"&"|bmAppendPoMMoInstance}">{t}Clear Notices{/t}</a>
	<hr>
	<span id="noticeWarn" style="float: right; visibility: padding: 3px 3px 3px 3px;" class="errMsg">
	 	...
	 	<a href="mailing_status2.php?command=clear50{"&"|bmAppendPoMMoInstance}">{t}Clear Last 50 Notices{/t}</a>
	</span>
	<span id="notice"></span>
</div>
...
var pb = {
  init: function() {
    ...
    this.updater = new Ajax.PeriodicalUpdater(
      'ajaxUpdate',
      '{/literal}ajax_status.php{"?"|bmAppendPoMMoInstance}{literal}',
      { 
        frequency: 5, 
