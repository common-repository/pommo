...
<div style="width:100%;">
	<span style="float: right; margin-right: 30px;">
		<a href="mailings_history.php{"?"|bmAppendPoMMoInstance}">{t 1=$returnStr}Return to %1{/t}</a>
	</span>
</div>
			...
			<tr>
				<td valign="top">
					{if $mailing.ishtml == 'on'}
						<p>
							<b>{t}HTML Body:{/t} </b>
								 <a href="mailing_preview.php?viewid={$key}{"&"|bmAppendPoMMoInstance}" target="_blank">{t escape=no 1='</a>'}Click here %1 to view in a new browser window.{/t}
						</p>
						{if $mailing.altbody}
							<p>
							<b>{t}Alt Body:{/t} </b>
