...
<div id="mainbar">
	...
	{if $mailing}
		<p>
			<a href="{$url.base}admin/mailings/mailing_status.php{"?"|bmAppendPoMMoInstance}">
	...
	{else}
		<p>
			<a href="{$url.base}admin/mailings/mailings_send.php{"?"|bmAppendPoMMoInstance}">
	...
	<p>
		<a href="{$url.base}admin/mailings/mailings_templates.php{"?"|bmAppendPoMMoInstance}">
		<img src="{$url.theme.shared}images/icons/form.png" class="navimage" />
		{t}Templates{/t}</a> - 
		{t}Create and edit templates used for your mailings.{/t} 
		<br>&nbsp;
		<br>&nbsp;
	</p>
	
	<p>
		<a href="{$url.base}admin/mailings/mailings_history.php{"?"|bmAppendPoMMoInstance}">
