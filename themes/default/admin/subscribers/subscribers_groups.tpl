...
{if $poMMo_package|is_a:'Package' and $poMMo_package|method_exists:'insertMarkup'}
	{$poMMo_package->insertMarkup($smarty_object,'edit_groups_extra')}
{/if}
...
<div width="100%">
	...
	<div style="border-top: 1px dotted; padding: 5px;">
		<a href="{$smarty.server.PHP_SELF}?group_id={$id}&delete=TRUE&group_name={$name}{"&"|bmAppendPoMMoInstance}">
	 	 		<img src="{$url.theme.shared}images/icons/delete.png" border="0" align="absmiddle"></a>
		<span style="margin-left: 25px;">
		<a href="groups_edit.php?group_id={$id}{"&"|bmAppendPoMMoInstance}">
