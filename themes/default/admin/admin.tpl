...
<h1>{t}Admin Menu{/t}</h1>
		<p>
			<a href="{$url.base}admin/setup/admin_setup.php?pk={$smarty.const.poMMo_instance}">
		...
		<p>
			<a href="{$url.base}admin/subscribers/admin_subscribers.php?pk={$smarty.const.poMMo_instance}">
		...
		<p>
			<a href="{$url.base}admin/mailings/admin_mailings.php?pk={$smarty.const.poMMo_instance}">
